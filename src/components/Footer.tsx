      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-20">
          ...
          <div>
             ...
             <ul className="space-y-4">
                <li><Link to="/" className="text-sm font-semibold text-[var(--text-muted)] hover:text-primary-600 transition-colors">Our Ethos</Link></li>
                <li><Link to="/careers" className="text-sm font-semibold text-[var(--text-muted)] hover:text-primary-600 transition-colors">Careers</Link></li>
                <li><Link to="/contact" className="text-sm font-semibold text-[var(--text-muted)] hover:text-primary-600 transition-colors">Contact Us</Link></li>
             </ul>
          </div>
