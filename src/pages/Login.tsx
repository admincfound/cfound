    ...
    <div className="min-h-screen flex items-start md:items-center justify-center px-6 pt-28 pb-16 md:py-20 bg-[var(--bg-main)] relative overflow-hidden">
      ...
      >
        <div className="text-center mb-5 md:mb-12">
          <div className="w-16 h-16 bg-primary-600 text-white rounded-[1.25rem] mx-auto flex items-center justify-center font-bold text-3xl mb-5 shadow-xl shadow-primary-600/20">C</div>
        ...
        >
          {loading ? (
            ...
            <>
              ...
              <span className="text-xs md:text-sm font-bold uppercase tracking-[0.15em] flex-1 text-center">Continue with Google</span>
