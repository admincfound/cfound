    ...
    try {
      ...
      jobsSnap.docs.forEach(doc => {
        ...
        data.push({
          ...
          photoURL:
            usersMap[app.userId]?.photoURL ||

            usersMap[app.userId]?.googlePhotoURL ||
              ...
              filteredApplications.map((app) => (
                ...
                >
                  <div className="flex items-center gap-8">
                    <div className="w-14 h-14 overflow-hidden rounded-2xl border border-primary-600/20 shadow-inner">
                      <img
                        src={
                          app.photoURL ||
              ...
              {selectedApp ? (
                ...
                >
                  ...
                  <div className="flex items-center gap-6 mb-12 relative z-10">
                    <div className="w-16 h-16 overflow-hidden rounded-2xl border border-primary-600/20">
                      <img
                        src={
                          profileData?.photoURL ||
                          '/default-avatar.png'
