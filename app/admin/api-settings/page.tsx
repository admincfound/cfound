    ...
    <div className="pt-16 pb-32 px-6 min-h-screen bg-[var(--bg-main)] text-[var(--text-main)]">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="flex flex-col md:flex-row items-start md:items-end justify-between gap-8 mb-16">
          ...
          >
            <Link href="/dashboard/admin" className="p-4 bg-[var(--bg-card)] border border-[var(--border-main)] rounded-2xl text-[var(--text-muted)] hover:text-primary-600 transition-colors shadow-xl">
              <ArrowLeft size={20} />
            </Link>
            <button 
              onClick={handleSave}
