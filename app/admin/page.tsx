      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex flex-col lg:flex-row items-start lg:items-center justify-between gap-8 mb-16">
          ...
          >
             ...
             <Link href="/admin/applications" className="btn-primary px-8 py-4 flex items-center gap-2">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
          ...
          <div className="space-y-8">
             ...
             <section className="p-10 bg-[var(--bg-card)] border border-[var(--border-main)] rounded-[3rem] shadow-2xl relative overflow-hidden group">
                ...
                <Link href="/blog" className="text-[10px] font-black text-primary-600 uppercase tracking-widest hover:pl-2 transition-all flex items-center gap-2">
