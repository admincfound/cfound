                ...
                >
                  ...
                  <div className="p-12 flex-1 flex flex-col">
                    ...
                    <div className="mt-auto pt-10 border-t border-[var(--border-main)] flex items-center justify-between">
                      <Link href={`/blog/${post.id}`} className="flex items-center gap-2 text-[10px] font-black uppercase tracking-[0.3em] text-primary-600 hover:gap-6 transition-all group/link">
