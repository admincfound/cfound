          ...
          <div className="max-w-4xl">
            ...
            >
              ...
              <div className="flex flex-col sm:flex-row items-center gap-6">
                {isAdmin ? (
                  <Link href="/admin" className="btn-primary w-full sm:w-auto text-center px-12 py-5 relative group overflow-hidden">
                  ...
                  <>
                    <Link href="/projects" className="btn-primary w-full sm:w-auto text-center px-12 py-5 shadow-[0_20px_50px_rgba(37,99,235,0.2)]">
                      Explore Portfolio
                    </Link>
                    <Link href="/internship" className="btn-secondary w-full sm:w-auto text-center px-12 py-5 border-2">
                       Internship Labs
                    </Link>
                  </>
                )}
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-10">
          <div className="relative max-w-5xl mx-auto p-6 md:p-12 lg:p-32 rounded-[4rem] bg-[var(--bg-card)] border border-[var(--border-main)] overflow-hidden text-center shadow-2xl">
            ...
            <p className="text-[var(--text-muted)] text-base md:text-2xl mb-10 md:mb-16 max-w-3xl mx-auto font-semibold leading-relaxed opacity-80 italic tracking-tight">
              ...
              {isAdmin ? (
                <>
                  <Link href="/admin" className="btn-primary px-6 py-3 md:px-10 md:py-5 text-xs shadow-2xl">Console Entry</Link>
                  <Link href="/admin/applications" className="btn-secondary px-6 py-3 md:px-10 md:py-5 text-xs">Review Queue</Link>
                </>
              ) : (
                <>
                  <Link href="/projects" className="btn-primary px-6 py-3 md:px-10 md:py-5 text-xs shadow-2xl">View Portfolio</Link>
                  <Link href="/internship" className="btn-secondary px-6 py-3 md:px-10 md:py-5 text-xs">Graduate Labs</Link>
                  <Link href="/careers" className="btn-secondary px-6 py-3 md:px-10 md:py-5 text-xs">Join the Fleet</Link>
                </>
              )}
            </div>
          </div>
