      ...
      <div className="max-w-7xl mx-auto">
        {!isAdmin && user && !completion.isComplete && (
          <div className="mb-10 bg-red-500/10 border border-red-500/20 p-5 md:p-7 rounded-2xl flex flex-col items-center justify-between gap-5 md:p-7">
            ...
            <Link href="/profile" className="px-6 py-3 bg-red-500 text-white rounded-xl font-semibold uppercase tracking-widest text-[10px] hover:bg-red-600 transition-colors whitespace-nowrap">
              Complete Profile
            </Link>
          </div>
        )}
                    ...
                    <div className="flex items-center gap-2 mt-3 flex-wrap">
                      {isAdmin && (
                        <div className="flex gap-3">
                          <button 
                            onClick={() => router.push(`/admin/jobs/edit/${opp.id}`)}
