            ...
            >
              ...
              <div className="relative z-10">
                ...
                <div className="space-y-3">
                  <Link href="/profile" className="w-full flex items-center justify-between p-5 bg-[var(--bg-main)] hover:bg-primary-600 hover:text-white border border-[var(--border-main)] rounded-2xl transition-all group/btn shadow-sm">
                  ...
                  {isAdmin && (
                    <Link href="/admin" className="w-full flex items-center justify-between p-5 bg-primary-600 text-white border border-primary-500 rounded-2xl transition-all group/btn shadow-xl shadow-primary-600/20">
                      <span className="text-[10px] font-black uppercase tracking-widest flex items-center gap-3">
